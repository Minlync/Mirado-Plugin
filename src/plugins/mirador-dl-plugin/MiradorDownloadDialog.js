...
import DialogActions from '@mui/material/DialogActions'; // updated
import DialogTitle from '@mui/material/DialogTitle'; // updated 
import Typography from '@mui/material/Typography'; // updated 
